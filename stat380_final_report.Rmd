...
-   **XGBoost (Purple Line)**: Performed the best with an AUC of
    *0.963*, hugging the top-left corner the tightest.
...
-   **SVM (Orange Line)**: Showed a "blocky" step function with an AUC
    of *0.772*, indicating less granular probability estimates.
-   **kNN (Red Line)**: Performed poorly, falling below the diagonal
    line with an AUC of *0.339* which performs worse than random
    guessing of 0.5.
